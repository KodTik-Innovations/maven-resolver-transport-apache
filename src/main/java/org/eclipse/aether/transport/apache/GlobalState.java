...
import org.kodtik.ide.http.conn.socket.ConnectionSocketFactory;
import org.kodtik.ide.http.conn.socket.PlainConnectionSocketFactory;
import org.kodtik.ide.http.conn.ssl.NoopHostnameVerifier;
import org.kodtik.ide.http.conn.ssl.SSLConnectionSocketFactory;
import org.kodtik.ide.http.impl.conn.DefaultHttpClientConnectionOperator;
import org.kodtik.ide.http.impl.conn.DefaultSchemePortResolver;
import org.kodtik.ide.http.impl.conn.ManagedHttpClientConnectionFactory;
import org.kodtik.ide.http.impl.conn.PoolingHttpClientConnectionManager;
import org.kodtik.ide.http.impl.conn.SystemDefaultDnsResolver;
import org.kodtik.ide.http.ssl.SSLContextBuilder;
import org.kodtik.ide.http.ssl.SSLInitializationException;
